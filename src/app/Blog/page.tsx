        ...
        <div className="w-full lg:w-1/4 space-y-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="space-y-4">
              {[
                { image: '/lift 1.jpg', title: 'Heavy Duty Small Lifting Machine', date: '03 Aug 2022' },
                { image: '/lift 2.jpg', title: 'Small Warehouse Machine', date: '03 Aug 2022' },
                { image: '/lift 5.jpeg', title: 'Heavy Duty Medium Lifter', date: '03 Aug 2022' },
                { image: '/lift 7.jpeg', title: 'Advanced Technology', date: '03 Aug 2022' },
                { image: '/p7.jpeg', title: 'Small Material Mixing Machine', date: '03 Aug 2022' },
              ].map((post, index) => (
